...
;	Alisson Rodrigues e Nathiele Cerqueira
...
;	FALTA: - Interrupção do botão, modo de emergência, incrementar a quantidade de veículos
...
INICIO:
	...
	MOV R5, #0d		; Inicializa modo normal
...
TROCAR_LED:
	...
	MOV A, R5         ; Verifica o valor de R5 (modo emergência)
...
AUX1:
	...
	AJMP INTRP_TIMER	; Continua tratamento da interrupção
